...
/*
// This is the method where we create size of the multiArr
    public static int [][] createMultiArr ( int columnSize , int rowSize ) {
...
*/
  ...
  /*  public static int [][] binaryMultiplication ( int arr [] , int arr2 []  , int multiArr [][] , int columnSize , int rowSize ) {


        // These 2 variables are used to control the added zeros we need to put in the end of the array.
    ...
    // in this method here we just print the array, so we can visually understand on how the addition will happen.
    ...
    // In this section we will perform the addition with the binary number  - calculating the carry over and the result
    public static int binaryAddition (int[][] multiArr, int columnSize , int rowSize  ) {
        int result;
        int carryOver = 0;
        int endResult = 0;
        ...
        for (int i = columnSize ; i >= 0; i--) {
            ...
            endResultSingleNumb =  addZeros(endResult , endResultSingleNumb, multiplier );
      ...
      return   endResultSingleNumb;
    }


    // this is the method where we take the end result and create 1 single integer to it. essentially each digit is multiplipled
    public static int addZeros(int endResult, int endResultSingleNumb, int multiplier) {
...
*/
        ...
        //   int firstNumber = numb1;

        //   int secondNumber = numb2;
        ...
        //    digitSeparate1(arr , numb1);

        //  digitSeparate2(arr2 ,numb2 );
    ...
    /*    int separatedDigits1 [] = digitSeparate1(arr, numb1);
        int separatedDigits2 [] = digitSeparate2(arr2, numb2);
        int multiplicationArr [][] = createMultiArr(columnSize, rowSize);


       int multiplicationResult [][]  = binaryMultiplication(separatedDigits1, separatedDigits2, multiplicationArr, columnSize, rowSize);


        printMultiArr(multiplicationResult);

       int end = binaryAddition(multiplicationResult, columnSize, rowSize);

        System.out.println(" " );
         System.out.println(" Binary number is  " +  end);
*/
